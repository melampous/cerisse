...
def plot_figure(
    ...
    with plt.rc_context(rc_parameters):
        # Two rows preserve an 8 pt final font within the 150 mm thesis
        # text block.  The former three-across layout reduced labels to
        # approximately 5 pt after inclusion.
        figure = plt.figure(figsize=(5.9055, 4.45))
        ...
        axes[0].set_ylabel(r"Normalised $L_2$ error")
