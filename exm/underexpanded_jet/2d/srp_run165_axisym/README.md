# 2d/srp_run165_axisym

Underexpanded jet case — auto-generated from `data_organization/manifest.py` on 2026-04-22.

## Identity
- **host**: `local`
- **path**: `/home/qiaoj/testcerisse/cerisse/exm/underexpanded_jet/2d/srp_run165_axisym`
- **dim**: 2D
...
## Notes
- SRP precursor #165, has local plt/aws_plt copies for offline inspection.

## Companion runs (same NPR, different host/level/physics)
- `aws:2d/srp_run165_axisym` (None, lev=None)
