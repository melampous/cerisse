...
struct ProbParm
{
  ...
  Real p_jet    = 99780.0 * 20.000000 / 1.89293;  // NPR=20.0000 (Mj=2.60) on exp-day p_amb
  Real T_jet    = 247.625;  // = 297.15/1.2 (sonic exit static T)
  Real Mach_jet = 1.0;

  Real r_jet     = 0.0127;    // 12.7 mm, D_e = 25.4 mm (Panda nozzle)
  Real delta_jet = 0.000000e+00;  // delta/De = 0.01, tanh lip layer

  Real r_flange  = 0.0127;    // = r_jet: no flange, ambient Dirichlet from the lip out
};
