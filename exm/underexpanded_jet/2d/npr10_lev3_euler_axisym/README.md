# 2d/npr10_lev3_euler_axisym

Underexpanded jet case — auto-generated from `data_organization/manifest.py` on 2026-04-22.

## Identity
- **host**: `local`
- **path**: `/home/qiaoj/testcerisse/cerisse/exm/underexpanded_jet/2d/npr10_lev3_euler_axisym`
- **dim**: 2D
- **coord_sys**: 1 (RZ axisymmetric)
- **NPR_0** (stagnation/ambient): 10.0
- **amr.max_level**: 3
...
- `pe/pa = NPR_0 / (1+0.2*M^2)^3.5 = 5.2828` (underexpanded).
...
## Notes
- Local source-only mirror.

## Companion runs (same NPR, different host/level/physics)
- `cx3:2d/npr10_lev3_euler_axisym` (euler, lev=3)
- `aws:2d/npr10_lev3_euler_axisym` (euler, lev=3)
