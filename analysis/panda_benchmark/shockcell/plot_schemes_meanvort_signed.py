#!/usr/bin/env python3
"""Signed mean-flow vorticity omega_z(<u>) De/Uj of the three schemes over
...
This is the vorticity of the TIME-MEAN velocity field (mean shear-layer
sheet), not <|omega|>. Diverging colour scale, true equal aspect."""
import numpy as np
import matplotlib
matplotlib.use("Agg")
...
fig.savefig(HERE / "paperfig_schemes_field_meanvort_signed.png", dpi=280)
fig.savefig(HERE / "paperfig_schemes_field_meanvort_signed.pdf", dpi=280)
print("wrote paperfig_schemes_field_meanvort_signed")
