...
four nozzle profiles over 0 < x/De < 16, z=0 plane. The M=1 contour is
...
XLIM, RLIM = 16.0, 1.4
CASES = [("baseline", "Baseline shifted tanh"),
         ("tophat", "Top hat"),
...
fig, axes = plt.subplots(4, 1, figsize=(9.6, 5.2), sharex=True,
...
fig.savefig(HERE / "mach16_profiles.png", dpi=250)
fig.savefig(HERE / "mach16_profiles.pdf", dpi=250)
print("wrote mach16_profiles.png/pdf")
for v, lab in CASES:
    d = np.load(HERE / ("MACH16_%s.npz" % v))
